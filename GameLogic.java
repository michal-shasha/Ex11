...
public class GameLogic implements PlayableLogic {
   ...
   public void initialize() //Initializes all powns at the starting position
    {
    ...
    public boolean move(Position a, Position b) {
        ...
        // displacement test when both are on the y-axis and also the y of a is greater than b
        if (a.getY() > b.getY()) {
        ...
        // displacement test when both are on the y-axis and also the y of b is greater than a
        ...
        //displacement test when both are on the x-axis and also the x of a is greater than b
        if (a.getX() > b.getX()) {
        ...
        // displacement test when both are on the x-axis and also the x of b is greater than a
        ...
        board[b.getY()][b.getX()] = (ConcretePiece) player1; //Update the Board with the player1 at Position b
        if (currentPlayer.isPlayerOne()) // Updates a 3D tempArr array and  increments the count in the appropriate cell of the array based on the tag of the piece at the new position.
        {
        ...
        eatPawn(b); //calling the function eatPawn
        gameFinish = eatKing(b); //calling the function eatKing and put in gameFinish
    ...
    public void eatPawn(Position b) //Function of eating only pawn type
    {
    ...
    public boolean eatKing(Position b)  //Function of eating only king type
    {
        if (getPieceAtPosition(b) == null) {
            return false;
        }
    ...
    @Override
    public ConcretePiece getPieceAtPosition(Position position)  //get position and return piece
    {
    ...
    @Override
    public Player getFirstPlayer() // Checks if this is the first player
    {
        return firstPlayer;
    }

    @Override
    public Player getSecondPlayer() // Checks if this is the second player
    {
        return secondPlayer;
    }

    public boolean kingInCorner() //Checks if the king is in the corner
    {
    ...
    @Override
    public boolean isGameFinished() //checks if the game is finished
    {
        if (kingInCorner()) {
            blueWon = true;
            printUp();
    ...
    @Override
    public void reset() //Initializes the board
    {
        for (int i = 0; i < 11; i++) {
            for (int j = 0; j < 11; j++) {
                board[i][j] = null;
